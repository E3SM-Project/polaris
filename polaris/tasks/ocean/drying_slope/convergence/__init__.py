...
from polaris.tasks.ocean.drying_slope.convergence.analysis import Analysis
from polaris.tasks.ocean.drying_slope.convergence.forward import Forward
...
class Convergence(Task):
    ...
    def __init__(
        ...
        for refinement_factor in refinement_factors:
            ...
            forward_dir = (
                f'{group_dir}/barotropic/{mesh_name}/{method}/{step_name}'
            )
