...
def get_woa23_steps(component, include_viz=False):
    ...
    include_viz : bool, optional
        Whether to include the :py:class:`.Woa23VizStep` in the returned
        ...
        standalone :py:class:`.Woa23` task passes ``include_viz=True``; other
        consumers that reuse the hydrography product as a dependency leave it
