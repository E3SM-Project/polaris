...
def _plot_top_bot_slice(ds, ds_mesh, ds_transect, descriptor,
    ...
    for suffix, z_index in [['Top', 0], ['Bot', ds.maxLevelCell - 1]]:
        plot_horiz_field(ds_mesh=ds_mesh,
                         ...
                         figsize=figsize, descriptor=descriptor,
                         transect_x=transect_x, transect_y=transect_y)
