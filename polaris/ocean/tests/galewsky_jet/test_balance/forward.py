...
class Forward(OceanModelStep):
    ...
    the galewsky jet - balanced test case
    ...
    def __init__(self, test_case, resolution):
        ...
        Parameters
        ----------
        test_case : polaris.ocean.tests.galewsky_jet.test_balance.TestBalance  # noqa: E501
        ...
        self.add_yaml_file(
            'polaris.ocean.tests.galewsky_jet.test_balance',
            'forward.yaml')
